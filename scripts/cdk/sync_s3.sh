...
if [[ $StableVersion == 'v1' ]]; then
    ...
    $AWS_CMD s3 cp main.zip s3://${bucket}/rs-dev-workshop-code/stable_v1/ --acl public-read
    $AWS_CMD s3 cp ./rs-raw-ec2.yaml s3://${bucket}/rs-dev-workshop-code/stable_v1/ --acl public-read
