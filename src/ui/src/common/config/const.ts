...
export const STORAGE_USER_ARN_ID =
  "__RECOMMENDATION_SYS_STORAGE_USER_ARN_ID__";
...
export const STORAGE_USER_ARN_URL =
  "__RECOMMENDATION_SYS_STORAGE_USER_ARN_URL__";
