...
const NewsDashboard: React.FC = () => {
      ...
      .then((res) => {
        ...
        clickCountBySource.forEach((element: any) => {
          if (element.source !== "recommend") {
            tmpCategroyList.push(element.source);
        ...
        setlineChartData({
          lineChartData: {
            ...
            normalCLickName: "Regular clicks",
            normalClickList: tmpNormalArr,
            recommendClickName: "Clicks based on recommendations",
  ...
  return (
    <div className="rs-app rs-movie">
      <Header />
      <div className="rs-movie-list dashboard">
        <div className="breadcrumb">
          <Breadcrumbs aria-label="breadcrumb">
            ...
            <Link style={{ color: "#fff" }} color="inherit" href="/#/movie">
              Movie
            </Link>
          ...
          <div className="dashboard-wrap">
            <div className="summary-card">
              <div className="card summary">
                ...
                <div className="name">Total Movie Count</div>
                <div className="count">
                  {totalNewsCount.toLocaleString()}
                  <span className="suffix"></span>
                </div>
                <div className="sub-title">
                  Recommended item coverage:
                  <b>{coverRatio.toFixed(2)}</b>%
                </div>
              ...
              <div className="card summary">
                ...
                <div className="name">Total User Count</div>
                <div className="count">
                  {userCount.totalUser.toLocaleString()}
                  <span className="suffix"></span>
                </div>
                <div className="sub-title">
                  Registered: <b>{userCount.registerUser.toLocaleString()}</b>{" "}
                  Anonymous: <b>{userCount.anonymousUser.toLocaleString()}</b>
                </div>
                {/* <div className="icon">ICON</div> */}
              </div>
              <div className="card summary">
                ...
                <div className="name">Total Click Count</div>
                <div className="count">
                  {totalNewsClick.toLocaleString()}
                  <span className="suffix"></span>
                </div>
                <div className="sub-title">
                  Recommended click rate: <b>{(clickRatio * 100).toFixed(2)}</b>
                  %
                </div>
                {/* <div className="icon">ICON</div> */}
              </div>
              <div className="card hot">
                <div className="chart-title">
                  ...
                  Popular movie click categories
                </div>
                <CategoryBarChart
                  foreColor="#eee"
                  chartTheme="dark"
        ...
        >
          <div className="sys-setting">
            ...
            <div className="btn">
              ...
              />
              <div className="tips">
                Add new item information to the recommendation system
              </div>
            </div>
            <div className="btn">
              <Button
              ...
              />
              <div className="tips">
                Train the model based on accumulated behavioral data
              </div>
            </div>
            <div className="btn">
              <Button
              ...
              />
              <div className="tips">
                Generate recommendation lists in batches based on the historical
