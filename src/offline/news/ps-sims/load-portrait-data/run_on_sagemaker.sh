...
repo_name=rs/news-ps-sims-load-portrait-data
...
--role-arn ${SM_ROLE} \
--processing-resources 'ClusterConfig={InstanceCount=1,InstanceType=ml.m5.2xlarge,VolumeSizeInGB=50}' \
--app-specification "ImageUri=${IMAGEURI},ContainerArguments=--bucket,${bucket},--prefix,${prefix},--region,${AWS_REGION}"