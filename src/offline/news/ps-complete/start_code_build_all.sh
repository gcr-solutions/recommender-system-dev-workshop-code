...
news_projects=(
  "lambda"
  "news/ps-complete/item-preprocessing"
  "news/ps-complete/action-preprocessing"
  "news/ps-complete/user-preprocessing"
  "news/ps-complete/batch-preprocessing"
  "news/ps-complete/step-funcs"
)
